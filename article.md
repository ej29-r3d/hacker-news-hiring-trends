...
For the first time since 2014 there are more people who seeks job than job postings.

{{chart hiring-chart.html?embed=1&title=hide&deck=hide 640}}

The drop started after Fed increased its rates, not because of AI. However after Fed started to decrease its rate we don't see that jobs rebounded. Also no visible correlation between AI and job posting activity on Hackernews yet.

{{chart avg-by-year.html?embed=1 560}}

Averaged over January–July, 2021 had 961 hiring comments a month against 219 from seekers. In 2026 it’s 488 against 502. The flip came in May and widened every month since.

{{chart seeker-share.html?embed=1 540}}

There is no less activity in jobs threads. Just flip in it: 
